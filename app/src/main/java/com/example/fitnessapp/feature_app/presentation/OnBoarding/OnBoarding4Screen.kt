...
//Назначение: верстка экрана OnBoarding4
//Дата: 25.02.2025
//Автор: Неробеев Алексей

@Composable
fun OnBoarding4Screen(navController: NavController, vm: OnBoardingVM = koinViewModel()) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()){ innerPadding ->
        Column(modifier = Modifier.padding(innerPadding)
            ...
            .draggable(state = rememberDraggableState { onDelta ->
                vm.onEvent(OnBoardingEvent.SwipeChange(onDelta, 4))
            },
                orientation = Orientation.Horizontal)) {
            Image(painter = painterResource(R.drawable.onb4_image),
            ...
            Box(modifier = Modifier
                ...
                IconButton(onClick = {
                    vm.onEvent(OnBoardingEvent.GoNext(4))
                },
                    modifier = Modifier
                        .padding(end = 35.dp)
