...
//Назначение: верстка экрана OnBoarding3
//Дата: 25.02.2025
//Автор: Неробеев Алексей

@Composable
fun OnBoarding3Screen(navController: NavController, vm: OnBoardingVM = koinViewModel()) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()){ innerPadding ->
        Column(modifier = Modifier.padding(innerPadding)
            ...
            .draggable(state = rememberDraggableState { onDelta ->
                vm.onEvent(OnBoardingEvent.SwipeChange(onDelta, 3))
            },
                orientation = Orientation.Horizontal)) {
            Image(painter = painterResource(R.drawable.onb3_image),
            ...
            Box(modifier = Modifier
                ...
                IconButton(onClick = {
                    vm.onEvent(OnBoardingEvent.GoNext(3))
                },
                    modifier = Modifier
                        .padding(end = 35.dp)
