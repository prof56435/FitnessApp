...
//Назначение: верстка экрана OnBoarding1
//Дата: 25.02.2025
//Автор: Неробеев Алексей

@Composable
fun OnBoarding1Screen(navController: NavController, vm: OnBoardingVM = koinViewModel()) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()){ innerPadding ->
        Column(modifier = Modifier.padding(innerPadding)
            ...
            .draggable(state = rememberDraggableState { onDelta ->
                vm.onEvent(OnBoardingEvent.SwipeChange(onDelta, 1))
            },
            ...
            Box(modifier = Modifier
                ...
                IconButton(onClick = {
                    vm.onEvent(OnBoardingEvent.GoNext(1))
                },
                    modifier = Modifier
                        .padding(end = 35.dp)
